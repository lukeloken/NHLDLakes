...
# FLAME_Data_Directory<-"Dropbox/FLAME_YaharaLakes/Data/2016-06-10_LakeMendota"
...
# starting directory - setwd("E:/Dropbox/FLAME_YaharaLakes/Data")
# ===========================================================

setwd("E:/Dropbox/FLAME_NHLDLakes/Data")
dirs<-list.files()
