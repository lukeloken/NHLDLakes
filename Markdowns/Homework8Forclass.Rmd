...
MEcsv <- read.csv("../../Zoo955/Data/MendotaBathy.csv", header=T)
MEoutline <- readOGR('../../Zoo955/Data/Shapefiles/Mendota_shape.shp', layer='Mendota_shape',stringsAsFactors = F)
MEbathy <- readOGR('../../Zoo955/Data/Shapefiles/Mendota_bathy.shp', layer='Mendota_bathy',stringsAsFactors = F)

MEoutline2 <- gUnaryUnion(MEbathy)

yld <- readOGR('../../Zoo955/Data/Shapefiles/yld_study_lakes.shp', 'yld_study_lakes', stringsAsFactors = F)
...
```{r, fig2, fig.width = 6, fig.align='center', fig.height=4.5, include=T }
...
#Calculate distance to shore of all points in polygrid
#These will be used for Kriging
...
plot(data1.grid, main='Distance to shore (m)')

```


```{r, fig3, fig.width = 4, fig.align='center', fig.height=3.5, include=T }
...
```{r, fig4, fig.width = 6.5, fig.align='center', fig.height=8, echo=F}
...
Who notied that Dr. Dugan changed the depths of the first 7 observations? 

The middle of the lake has a shallow hump. 
